...
export class TrackingApi {
    ...
    public async getTrackings(query?: GetTrackingsQuery, headers?: {[key: string]: any}): Promise<GetTrackingsResponse> {
        ...
        return this.request.makeRequest<GetTrackingsResponse>({url: `/tracking/2024-10/trackings`, method: "GET", query, headers, request_legacy_tag: "", response_legacy_tag: "trackings", is_paging: true})
    }
    /**
    ...
    public async createTracking(body: CreateTrackingRequest, headers?: {[key: string]: any}): Promise<CreateTrackingResponse> {
        ...
        return this.request.makeRequest<CreateTrackingResponse>({url: `/tracking/2024-10/trackings`, method: "POST", body, headers, request_legacy_tag: "", response_legacy_tag: "", is_paging: false})
    }
    /**
    ...
    public async getTrackingById(id: string, query?: GetTrackingByIdQuery, headers?: {[key: string]: any}): Promise<GetTrackingByIdResponse> {
        ...
        return this.request.makeRequest<GetTrackingByIdResponse>({url: `/tracking/2024-10/trackings/${id}`, method: "GET", query, headers, request_legacy_tag: "", response_legacy_tag: "", is_paging: false})
    }
    /**
     * Update a tracking.
     */
    public async updateTrackingById(id: string, body: UpdateTrackingByIdRequest, headers?: {[key: string]: any}): Promise<UpdateTrackingByIdResponse> {
        ...
        return this.request.makeRequest<UpdateTrackingByIdResponse>({url: `/tracking/2024-10/trackings/${id}`, method: "PUT", body, headers, request_legacy_tag: "", response_legacy_tag: "", is_paging: false})
    }
    /**
     * Delete a tracking.
     */
    public async deleteTrackingById(id: string,  headers?: {[key: string]: any}): Promise<DeleteTrackingByIdResponse> {
        ...
        return this.request.makeRequest<DeleteTrackingByIdResponse>({url: `/tracking/2024-10/trackings/${id}`, method: "DELETE", headers, request_legacy_tag: "", response_legacy_tag: "", is_paging: false})
    }
    /**
    ...
    public async retrackTrackingById(id: string,  headers?: {[key: string]: any}): Promise<RetrackTrackingByIdResponse> {
        ...
        return this.request.makeRequest<RetrackTrackingByIdResponse>({url: `/tracking/2024-10/trackings/${id}/retrack`, method: "POST", headers, request_legacy_tag: "", response_legacy_tag: "", is_paging: false})
    }
    /**
    ...
    public async markTrackingCompletedById(id: string, body: MarkTrackingCompletedByIdRequest, headers?: {[key: string]: any}): Promise<MarkTrackingCompletedByIdResponse> {
        ...
        return this.request.makeRequest<MarkTrackingCompletedByIdResponse>({url: `/tracking/2024-10/trackings/${id}/mark-as-completed`, method: "POST", body, headers, request_legacy_tag: "", response_legacy_tag: "", is_paging: false})
    }
}