...
export class EstimatedDeliveryDateApi {
    ...
    public async predictBatch(body: PredictBatchRequest, headers?: {[key: string]: any}): Promise<PredictBatchResponse> {
        ...
        return this.request.makeRequest<PredictBatchResponse>({url: `/tracking/2024-07/estimated-delivery-date/predict-batch`, method: "POST", body, headers, request_legacy_tag: "", response_legacy_tag: "", is_paging: false})
    }
}