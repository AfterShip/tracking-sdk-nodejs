 ...
 */
import { OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateRequest } from "./OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateRequest";

export interface EstimatedPickupEstimatedDeliveryDateRequest {
    /**
