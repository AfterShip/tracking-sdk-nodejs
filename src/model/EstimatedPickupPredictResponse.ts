 ...
 */
import { OrderProcessingTimeEstimatedPickupPredictResponse } from "./OrderProcessingTimeEstimatedPickupPredictResponse";

export interface EstimatedPickupPredictResponse {
  /**
   ...
   *
   */
  order_processing_time?: OrderProcessingTimeEstimatedPickupPredictResponse;
  /**
