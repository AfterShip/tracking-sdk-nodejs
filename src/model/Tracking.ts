...
import { Tag } from "./Tag";
import { TrackingOrderPromisedDeliveryDate } from "./TrackingOrderPromisedDeliveryDate";
...
import { TrackingProofOfDelivery } from "./TrackingProofOfDelivery";
import { TrackingReturnShipment } from "./TrackingReturnShipment";
import { TrackingShipmentDimensions } from "./TrackingShipmentDimensions";
...
import { TrackingShipmentDirection } from "./TrackingShipmentDirection";
...
import { TrackingMultiPieceInfo } from "./TrackingMultiPieceInfo";
import { TrackingForwardShipment } from "./TrackingForwardShipment";
...
export interface Tracking {
   ...
   */
  courier_estimated_delivery_date?: TrackingCourierEstimatedDeliveryDate | null;
  /**
   ...
   */
  shipment_weight?: TrackingShipmentWeight | null;
  /**
   * Physical dimensions of the package (length, width and height).
   */
  shipment_dimensions?: TrackingShipmentDimensions | null;
  /**
   ...
   */
  order_promised_delivery_date?: TrackingOrderPromisedDeliveryDate | null;
  /**
   ...
   */
  aftership_estimated_delivery_date?: TrackingAftershipEstimatedDeliveryDate | null;
  /**
   ...
   */
  custom_estimated_delivery_date?: TrackingCustomEstimatedDeliveryDate | null;
  /**
   ...
   */
  first_estimated_delivery?: TrackingFirstEstimatedDelivery | null;
  /**
   * The most recently calculated estimated delivery date. It could be provided by the carrier, AfterShip AI, or based on your custom settings. The format of carrier EDDs may differ depending on how the carrier provides it:- YYYY-MM-DD- YYYY-MM-DDTHH:mm:ss- YYYY-MM-DDTHH:mm:ssZ AfterShip AI and custom EDDs always use the format `YYYY-MM-DD`. All EDDs use the shipment recipient’s timezone.
   */
  latest_estimated_delivery?: TrackingLatestEstimatedDelivery | null;
  /**
   ...
   */
  carbon_emissions?: TrackingCarbonEmissions | null;
  /**
   ...
   */
  first_mile?: TrackingFirstMile | null;
  /**
   ...
   */
  last_mile?: TrackingLastMile | null;
  /**
   ...
   */
  multi_piece_info?: TrackingMultiPieceInfo | null;
  /**
   ...
   */
  return_shipment?: TrackingReturnShipment | null;
  /**
   ...
   */
  forward_shipment?: TrackingForwardShipment | null;
}
