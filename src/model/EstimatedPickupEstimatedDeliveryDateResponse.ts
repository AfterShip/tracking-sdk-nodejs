 ...
 */
import { OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateResponse } from "./OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateResponse";

export interface EstimatedPickupEstimatedDeliveryDateResponse {
    /**
