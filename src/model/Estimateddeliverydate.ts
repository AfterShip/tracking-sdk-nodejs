 ...
 */
import { OriginAddressEstimateddeliverydate } from "./OriginAddressEstimateddeliverydate";
import { DestinationAddressEstimateddeliverydate } from "./DestinationAddressEstimateddeliverydate";
import { WeightEstimateddeliverydate } from "./WeightEstimateddeliverydate";
import { EstimatedPickupEstimateddeliverydate } from "./EstimatedPickupEstimateddeliverydate";
...
export interface Estimateddeliverydate {
     ...
     */
    origin_address: OriginAddressEstimateddeliverydate;
    /**
     * The final destination of the customer where the delivery will be made.
     */
    destination_address: DestinationAddressEstimateddeliverydate;
    /**
     * AfterShip uses this object to calculate the total weight of the order.
     */
    weight?: WeightEstimateddeliverydate;
    /**
     ...
     */
    estimated_pickup?: EstimatedPickupEstimateddeliverydate;
}
